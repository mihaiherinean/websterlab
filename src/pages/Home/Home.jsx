...
function Home() {
    ...
    <div className="w-[100%] h-[100vh] relative">
        ...
        <div className="w-[100%] h-[400px] md:h-[500px] absolute top-0 ease-in-out duration-300 flex justify-center items-center"><iframe title="animation" src="https://embed.lottiefiles.com/animation/108333" className="w-[85%] h-[85%] md:w-[100%] md:h-[100%] object-cover"></iframe></div>
